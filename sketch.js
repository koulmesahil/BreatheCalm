...
function setup() {
  ...
  button.style("background-color", "#ff5271");
  ...
  refreshButton.style("background-color", "#ff5271");
...
function draw() {
  ...
  if (timerRunning) {
    ...
    textSize(30);
    fill(0);
    text("🕖", width / 2, height - 60); // Timer icon centered horizontally at bottom

    fill(0);
    textSize(30);
    text(timerText, width / 2, height - 30); // Display the time at the bottom
  }
